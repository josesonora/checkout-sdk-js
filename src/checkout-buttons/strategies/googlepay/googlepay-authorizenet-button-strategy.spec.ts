...
import { createGooglePayPaymentProcessor, GooglePaymentData, GooglePayAuthorizeNetInitializer, GooglePayPaymentProcessor } from '../../../payment/strategies/googlepay';
...
describe('GooglePayCheckoutButtonStrategy', () => {
    ...
    describe('#handleWalletButtonClick', () => {
        ...
        beforeEach(() => {
            googlePayOptions = getCheckoutButtonOptions(Mode.GooglePayAuthorizeNet);
